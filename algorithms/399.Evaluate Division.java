class Solution {
    ...
    double getPathWeight(String start, String end, Set<String> visited, Map<String, Map<String, Double>> graph) 
    {
        ...
        if(!visited.contains(neighbour.getKey())) 
        {
            ...
            if(productWeight!=-1.0) return neighbour.getValue()*productWeight;
        }
        return -1.0;
    }
